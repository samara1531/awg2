# AmneziaWG 2.0-3.0 OpenWRT 
- **awg 3.0 от wrt 25.12.5 и выше**
- **а так-же в релизе 24.10.8**_v3.0 **но без модуля Go**
+ На неподдерживаемые архитектуры awg-go не собирается (архивы меньше 1 МБ).
+ 
...
+ Через amneziawg-go, потребляет гораздо больше озу и для хорошей сетевой скорости требует производительного цпу.
  ...
  - (потребление озу 10-60 Мб на каждый запущенный интерфейс. чем лучше процессор и объемы трафика, тем больше)
+
+ **kmod-amneziawg, на "кастомные" прошивки не установится. только на официальный ванильный wrt**
  - остальные ipk привязаны только к архитектуре процессора.
  - если использовать через awg-go, можно в **теории** поставить на любую сборку.
  - (используйте MTU= **1280**)
+
+ Требуется удалить старые пакеты амнезии, перед установкой новых. критично для awg-tools.
