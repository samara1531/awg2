...
+ Через amneziawg-go, потребляет гораздо больше озу и для хорошей сетевой скорости требует производительного цпу.
  ...
  - может не обновляться сама по себе статистика на интерфейсе, только когда идет запрос на сервер. проверяйте наличие подключения по факту, а не по Получено (Rx)
+
