...
+ При установке kmod-amneziawg Он становится приоритетным, запуск идет через него. игнорируя наличие awg-go. (это прописано в amneziawg-tools)
+ 
...
- `apk add bash`
- `bash -c "$(wget -qO- https://raw.githubusercontent.com/samara1531/awg2/main/autoinstall-awg.sh)"`
+ Для варианта с **GO** (сначала установите bash)
